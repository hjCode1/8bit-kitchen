...
export default function AddIngredientModal({ isOpen, onClose, onAdd }: AddIngredientModalProps) {
  ...
  return (
    <PixelModal isOpen={isOpen} onClose={handleClose} title="재료 추가">
      <div className="mb-3">
        <p className="text-[16px] text-pixel-text mb-1">카테고리</p>
        <div className="flex flex-wrap gap-1">
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={`
                text-[15px] px-2 py-1 border-2 border-pixel-border cursor-pointer
      ...
      <div className="mb-3">
        <p className="text-[16px] text-pixel-text mb-1">재료 선택</p>
          ...
          <div className="flex flex-wrap gap-1">
            {presets.map((preset) => (
              <button
                ...
                className={`
                  text-[15px] px-2 py-1 border border-pixel-border cursor-pointer
